    ...
    return (
      ...
      <h2><br/>
        <div className="form-group">
          ...
          Blood Group
          <select name="BG">
	        <option id="b0" value="0th" selected>select</option>
	        <option id="b1" value="1st" >A+</option>
          <option id="b2" value="2nd" >A-</option>
          <option id="b1" value="1st" >B+</option>
          <option id="b1" value="1st" >B-</option>
          <option id="b1" value="1st" >O+</option>
          <option id="b1" value="1st" >O-</option>
          <option id="b1" value="1st" >AB+</option>
          <option id="b1" value="1st" >AB-</option>
          </select>
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          />
	        Medically fit
	        <select name="fit">
	        <option id="f0" value="0th" selected>select</option>
	        <option id="f1" value="1st" >Yes</option>
          <option id="f2" value="2nd" >No</option>
          </select>
          </div>
          <div className="form-group">
          Mobile
        ...
        <button onClick={this.clickSubmit} >Sign up</button><br/>
        <form action="Signin">
         <h1>
